    ...
    <section class="text-gray-600">
        <div class="container px-5 py-24 mx-auto">
            <div class="lg:w-2/4 w-full mx-auto overflow-auto">
                ...
                <form enctype="multipart/form-data" method="POST" action="{{route('admin.update', $product->id)}}">
                    @csrf
                    @method('put')
                    <div class="flex flex-wrap">
                        ...
                        @if($product->cover)
                        <div class="p-2 w-1/2">
                            <img src="{{\Illuminate\Support\Facades\Storage::url($product->cover)}}" alt="imagem do produto">
                            <a href="{{route('admin.destroyImage', $product->id)}}" class="leading-7 text-sm text-red-500">Excluir imagem de capa</a>
                        </div>
                        @endif
